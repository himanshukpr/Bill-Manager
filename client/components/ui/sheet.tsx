...
type SheetPointerOutsideEvent = Parameters<
  NonNullable<React.ComponentProps<typeof SheetPrimitive.Content>["onPointerDownOutside"]>
>[0]

type SheetInteractOutsideEvent = Parameters<
  NonNullable<React.ComponentProps<typeof SheetPrimitive.Content>["onInteractOutside"]>
>[0]
  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        data-side={side}
        onPointerDownOutside={(event: SheetPointerOutsideEvent) => {
          if (shouldPreventOutsideDismissOnMobile()) {
            event.preventDefault()
          }
          onPointerDownOutside?.(event)
        }}
        onInteractOutside={(event: SheetInteractOutsideEvent) => {
          if (shouldPreventOutsideDismissOnMobile()) {
            event.preventDefault()
          }
